...
export default function Home() {
  const [step, setStep] = useState(0); // 0: initial delay, 1: arc+plane animation, 2: pause, 3: reveal content
  ...
  useEffect(() => {
    // Step 0: Initial delay, after 700ms go to step 1
    if (step === 0) {
    ...
    // Step 2: Brief pause, after 600ms go to step 3
    if (step === 2) {
    ...
    >
      ...
      <AnimatePresence>
        {showSecond && (
          ...
          >
            <h2 className="text-2xl font-bold">What's new in Voyagr?</h2>
            <AnimatedListDemo />
          </motion.article>
        )}
      </AnimatePresence>
