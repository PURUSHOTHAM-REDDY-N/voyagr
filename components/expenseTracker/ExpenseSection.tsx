...
import Balances from "@/components/expenseTracker/Balances";
...
const ExpenseSection = ({ planId }: { planId: string }) => {
  const { data } = useSWR(`/api/plans/${planId}/expenses`, fetcher, {
    ...
    return (
      <>
        ...
        <ExpenseMetrics
          ...
          preferredCurrency={preferredCurrency || "INR"}
        />
        <Balances planId={planId} expenses={data} preferredCurrency={preferredCurrency || "INR"} />
