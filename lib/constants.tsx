import type {ContentGenerationState} from "@prisma/client";
import {
  Backpack,
  Clock3,
  Info,
...
// Drives both the "preferred pace" filter in the recommendation engine
// (lib/server/recommendationEngine.ts) and the number of activities/day
// the AI is asked to plan for.
